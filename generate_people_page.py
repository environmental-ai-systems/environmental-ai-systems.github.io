...
for category in ['students', 'academics', 'researchers', 'fellows', 'postdocs']:
...
def generate_person_card(person):
    ...
    if person.get('hobby'):
        card += f'                <div class="person-hobby"><strong>Fun fact:</strong> ⚡ {person["hobby"]}</div>\n'
    if person.get('tools'):
...
# Academics section
if people_data.get('academics'):
    html_template += '        <h2 class="section-title">Faculty</h2>\n'
...
if people_data.get('fellows'):
    html_template += '        <h2 class="section-title">Research Fellows</h2>\n'
    html_template += '        <div class="person-grid">\n'
...
if people_data.get('postdocs'):
    html_template += '        <h2 class="section-title">Postdoctoral Researchers</h2>\n'
    html_template += '        <div class="person-grid">\n'
...
if people_data.get('students'):
    html_template += '        <h2 class="section-title">PhD Students</h2>\n'
    html_template += '        <div class="person-grid">\n'
...
if people_data.get('researchers'):
    html_template += '        <h2 class="section-title">Researchers</h2>\n'
    html_template += '        <div class="person-grid">\n'
